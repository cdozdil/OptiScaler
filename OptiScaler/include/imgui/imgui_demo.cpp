...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    // ImGui::PushItemWidth(-ImGui::GetWindowWidth() * 0.35f);   // e.g. Use 2/3 of the space for widgets and 1/3 for
    // labels (right align)
    ...
    if (ImGui::CollapsingHeader("Configuration"))
    {
        ...
        if (ImGui::TreeNode("Backend Flags"))
        {
            ...
            ImGui::CheckboxFlags("io.BackendFlags: RendererHasTexReload", &io.BackendFlags,
...
void ImGui::ShowAboutWindow(bool* p_open)
{
    ...
    if (show_config_info)
    {
        ...
        ImGui::Text("io.Fonts: %d fonts, Flags: 0x%08X, TexSize: %d,%d", io.Fonts->Fonts.Size, io.Fonts->Flags,
                    io.Fonts->TexData.TexWidth, io.Fonts->TexData.TexHeight);
...
static const char* fonts[] = {
    "Default (built-in)", "Roboto-Medium.ttf", "Cousine-Regular.ttf", "DroidSans.ttf", "ProggyTiny.ttf",
};
...
static void ShowFontDemo(FontDemoState& state)
{
    ...
    ImGui::Text("Atlas texture (%dx%d pixels)", atlas->TexData.TexWidth, atlas->TexData.TexHeight);
    {
        ...
        ImGui::Image(ImTexture(atlas), ImVec2((float) atlas->TexData.TexWidth, (float) atlas->TexData.TexHeight),
...
void ImGui::ShowFontDemoWindow()
{
    if (ImGui::Begin("Font Test"))
    {
        ...
        ImGui::Text("Backends: '%s' + '%s'", io.BackendPlatformName ? io.BackendPlatformName : "",
                    io.BackendRendererName ? io.BackendRendererName : "");
        ImGui::CheckboxFlags("io.BackendFlags: RendererHasTexReload", &backend_flags,
                             ImGuiBackendFlags_RendererHasTexReload);
        ...
        ImGui::SameLine();
        HelpMarker("Otherwise last rebuilt will be applied to current atlas.");
