...
static ID3D12GraphicsCommandList* fgCopyCommandListSL[FrameGen_Dx12::FG_BUFFER_SIZE] = { nullptr, nullptr, nullptr, nullptr };
...
{
    if (fgFrameTimes.size() > 0)
        return fgFrameTimes.back();
